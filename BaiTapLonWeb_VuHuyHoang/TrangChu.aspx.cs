    ...
    public partial class TrangChuaspx : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            foreach (Products product in list)
            {
                ...
                //html += "<li onclick=\"hideImage(this)\">";
                ...
                //html += "<button style=\"\" class=\"mua\"><i class=\"fa-sharp fa-solid fa-cart-shopping\"><a  href=\"ChiTietSP.aspx?id=" + product.Id + "\">Mua</a></i></button>";
